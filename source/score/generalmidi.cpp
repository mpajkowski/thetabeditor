...
static const uint8_t pitchClasses[NUM_PITCH_CLASSES] = { 3, 10, 5, 0, 7, 2, 9, 4, 11, 6, 1, 8,
                                                         3, 10, 5, 0, 7, 2, 9, 4, 11, 6, 1, 8,
                                                         3, 10, 5, 0, 7, 2, 9, 4, 11, 6, 1 };
...
static const std::string sharpNotesText[12] = { "C",  "C#", "D",  "D#", "E",  "F",
                                                "F#", "G",  "G#", "A",  "A#", "B" };

static const std::string flatNotesText[12] = {
                            ...
                            bool forceAccidentals)
{
  ...
  if (lowerLimit <= bestMatch && upperLimit >= bestMatch && !forceAccidentals) {
    if (text.length() > 1) {
