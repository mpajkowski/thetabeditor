...
bool ChordName::operator==(ChordName const& other) const
{
  return myTonicKey == other.myTonicKey && myTonicVariation == other.myTonicVariation &&
         ...
         myFormula == other.myFormula && myModifications == other.myModifications &&
         myHasBrackets == other.myHasBrackets && myIsNoChord == other.myIsNoChord;
}
...
bool ChordName::hasModification(ChordName::FormulaModification modification) const
{
  return myModifications.test(modification);
}

void ChordName::setModification(ChordName::FormulaModification modification, bool set)
{
...
std::ostream& operator<<(std::ostream& os, ChordName const& chord)
{
  ...
  static std::string theSuffixes[] = { "",  "m",    "+",  "°",  "5",  "6",      "m6",
                                       "7", "maj7", "m7", "+7", "°7", "m/maj7", "m7b5" };
  static std::array<ChordName::FormulaModification, 13> theModifications = { { ChordName::Suspended2nd,
                                                                               ChordName::Suspended4th,
                                                                               ChordName::Added2nd,
                                                                               ChordName::Added4th,
                                                                               ChordName::Added6th,
                                                                               ChordName::Added9th,
                                                                               ChordName::Added11th,
                                                                               ChordName::Flatted13th,
                                                                               ChordName::Raised11th,
                                                                               ChordName::Flatted9th,
                                                                               ChordName::Raised9th,
                                                                               ChordName::Flatted5th,
                                                                               ChordName::Raised5th } };
  static std::string theModificationText[] = { "sus2", "sus4", "add2", "add4", "add6", "add9", "add11",
                                               "b13",  "+11",  "b9",   "+9",   "b5",   "+5" };
  ...
  if (chord.getTonicKey() != chord.getBassKey() || chord.getTonicVariation() != chord.getBassVariation()) {
    os << "/";
