...
void ScoreUtils::addStandardFilters(Score& score)
{
  ...
  filter_guitars.addRule(FilterRule(FilterRule::NUM_STRINGS, FilterRule::GREATER_THAN_EQUAL, 6));
  score.insertViewFilter(filter_guitars);

  ViewFilter filter_basses;
  filter_basses.setDescription("Basses");
  filter_basses.addRule(FilterRule(FilterRule::NUM_STRINGS, FilterRule::LESS_THAN_EQUAL, 5));
