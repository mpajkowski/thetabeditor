...
void TheTabEditor::editPlayer(int playerIndex, const Player &player,
                                bool undoable)
{
    ScoreLocation &location = getLocation();
...
void TheTabEditor::createCommands()
{
    ...
    connect(myRewindCommand, &QAction::triggered, this,
            &TheTabEditor::rewindPlaybackToStart);
    ...
    connect(myInsertStaffBeforeCommand, &QAction::triggered, this,
            &TheTabEditor::insertStaffBefore);
    ...
    connect(myRemoveCurrentStaffCommand, &QAction::triggered, this,
            &TheTabEditor::removeCurrentStaff);
    ...
    connect(myLeftHandFingeringCommand, &QAction::triggered, this,
            &TheTabEditor::editLeftHandFingering);
...
Command *TheTabEditor::createCommandWrapper(
...
void TheTabEditor::createNoteDurationCommand(
...
void TheTabEditor::createRestDurationCommand(
    Command *&command, const QString &menuName, const QString &commandName,
    Position::DurationType durationType)
{
    command = new Command(menuName, commandName, QKeySequence(), this);
...
void TheTabEditor::createPositionPropertyCommand(
    Command *&command, const QString &menuName, const QString &commandName,
...
void TheTabEditor::editSimplePositionProperty(
...
void TheTabEditor::editSimpleNoteProperty(Command *command,
                                            Note::SimpleProperty property)
{
    ScoreLocation &location = getLocation();
