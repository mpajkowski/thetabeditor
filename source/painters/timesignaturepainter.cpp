...
TimeSignaturePainter::TimeSignaturePainter(
    const LayoutConstPtr &layout, const TimeSignature &time,
                                      ...
                                      const int number) const
{
    ...
    const double x =
        LayoutInfo::centerItem(0, LayoutInfo::getWidth(myTimeSignature), width);
