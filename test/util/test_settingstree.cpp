...
TEST_CASE("Util/SettingsTree/JSON/Export")
{
  ...
  settings.setList("key_c", std::vector<std::string>({ "string1", "string2", "string3" }));
  ...
  std::ifstream expected_file(AppInfo::getAbsolutePath("data/test_settingstree_expected.json"));
...
{
  std::ifstream input_file(AppInfo::getAbsolutePath("data/test_settingstree_expected.json"));
