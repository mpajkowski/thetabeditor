...
if ( WITHERSHINS_FOUND )
    ...
    add_subdirectory( ${THETA_EXTERNAL_DIR}/withershins )

    message( STATUS "Using withershins library from ${THETA_EXTERNAL_DIR}/withershins" )

    set_target_properties(
        withershins PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES ${THETA_EXTERNAL_DIR}/withershins/src
    )

    # Set folder name for Visual Studio projects.
    set_target_properties(
        withershins PROPERTIES
        FOLDER ${THETA_EXTERNAL_FOLDER_NAME}
    )
endif ()
